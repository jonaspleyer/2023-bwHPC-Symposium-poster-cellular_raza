...
\begin{align}
    \sigma_{i,j} &= \frac{r_{i,j}}{R_i + R_j}\\
...
\begin{equation}
    \partial^2_t x_i = \sum\limits_j F_{i,j} - \lambda \partial_t x_i
\end{equation}
...
\begin{equation}
    S = \frac{1}{1-p}=\lim\limits_{n\rightarrow\infty}T(n)
...
In addition to hardware-related effects, we also expect a portion of $1-p$ our simulation code
